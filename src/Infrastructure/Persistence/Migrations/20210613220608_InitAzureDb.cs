    ...
    public partial class InitAzureDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ModalityCode = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    ModalityName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastModified = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LocalPID = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IrasProjectID = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EudraCTReference = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HRAReference = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    IsInvolvingMedicalDeviceTrial = table.Column<bool>(type: "bit", nullable: false),
                    IsInvolvingRadiotherapy = table.Column<bool>(type: "bit", nullable: false),
                    IsInvolvingRadioactiveSubstances = table.Column<bool>(type: "bit", nullable: false),
                    IsMultiCentre = table.Column<bool>(type: "bit", nullable: false),
                    NumberOfUKCentres = table.Column<int>(type: "int", nullable: false),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastModified = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DisplayTerm = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
                    RecommendedSubstituteProcedure = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModalityId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SNOMEDCT_ConceptID = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SNOMEDCT_LateralityID = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SNOMEDCT_FSN = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BodyPartMultiplicationFactor = table.Column<int>(type: "int", nullable: false),
                    IsInterventional = table.Column<bool>(type: "bit", nullable: false),
